...
domain: GOBERNANZA
status: DRAFT
activation_trigger: Cuando haya proceso de innovación activo
visibility: [INTERNAL]
...
## Enforcement
- **Detección:** Idea nueva propuesta sin pasar por framework de evaluación
- **Acción:** Redirigir al framework antes de ejecutar
- **Severidad:** SOFT — no bloquea, pero documenta decisión
