...
fuente: Research sesion 2026-03-01
aplica_a: [MWT]

# Nota PR-0 AUDIT 2026-05-03: la seccion `## I. PRICING OEM` queda excluida del indice
# pgvector PUBLIC/INTERNAL via campo `ceo_only_sections` (POL_VISIBILIDAD §regla ingestion).
# Las filas OQ-08 y OQ-09 dentro de la seccion G estan marcadas [PENDIENTE — CEO-ONLY]
# en prosa: cuando se completen sus valores reales, deben moverse a la seccion I o
# agregarse como Field IDs adicionales en `ceo_only_sections`.
...
- Referencia: scanner fitting asociado a +$13/orden y -27% devoluciones [HALLAZGO LLM — requiere validación con datos propios post-piloto]
