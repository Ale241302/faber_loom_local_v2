...
> **Nota absorción:** ENT_OPS_INVENTARIO v0.1 fue absorbido en este archivo (2026-04-01). Su contenido (safety stock 35d, semáforos, regla PPC <21d) ya estaba cubierto en secciones D3, F2, F5. Ref canónica ahora es este archivo.

### A1. Fase actual: F1 MANUAL
- 1 producto activo (Goliath), 6 SKUs, 1 canal (Amazon FBA), 1 mercado (USA)
- Historial: <12 meses
- Método: reglas manuales
...
- v0.2 (2026-04-01): Absorción ENT_OPS_INVENTARIO v0.1. Nota de absorción en sección A. Depuración Q2-2026.
