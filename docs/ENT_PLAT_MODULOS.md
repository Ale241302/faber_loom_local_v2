...
Stack técnico: ref → ENT_PLAT_INFRA
...
Arquitectura (frontends, infra): ref → ENT_PLAT_INFRA
...
| Dato/Regla | Entity requerido | Status |
|------------|-----------------|--------|
| Safety stock 35d, semáforos | ENT_OPS_DEMAND_PLANNING | ✅ Existe |
| Regla PPC vs stock | ENT_OPS_DEMAND_PLANNING | ✅ Existe |
