# PLB_FABERLOOM_KB_PROMOTION_v1 — Playbook de promocion AUDIT_FABERLOOM → canon KB · roadmap D1-D10 + U1-U8 + O1-O3 + 6 brechas + 21 OQ
id: PLB_FABERLOOM_KB_PROMOTION_v1
version: 1.0
status: DRAFT
visibility: [INTERNAL]
domain: Gobernanza (IDX_GOBERNANZA)
type: PLB
stamp: DRAFT — 2026-04-20
aprobador: CEO
fuente: Claude Code handoff (DELIVERY_NOTES_v3_5 post-mockup 461 KB · 7935 lineas · PR #1 abierto sjoalfaro/mwt-knowledge-hub). Complemento operativo de la serie AUDIT_FABERLOOM_.
aplica_a: [FaberLoom, MWT KB curation]
relacionado: AUDIT_FABERLOOM_A1..A7_v1 · AUDIT_FABERLOOM_B0..B1_v1 · AUDIT_FABERLOOM_AC_V3_5_v1 · ENT_GOB_PENDIENTES (track FABERLOOM)
...
- v1.0 (2026-04-20): indexado como PLB en dominio Gobernanza. Fuente: HANDOFF_TO_COWORK.md generado 2026-04-19 post-mockup v3.5. Funcion: playbook operativo que mapea cada decision/contradiccion/brecha de la serie AUDIT_FABERLOOM_ hacia su target de promocion en la KB canonica (D1-D10 nuevos · U1-U8 edits · O1-O3 referencias · 6 schemas faltantes · 21 OQ priorizadas P0/P1/P2/P3). Contenido verbatim del handoff.
