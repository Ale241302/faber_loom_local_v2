...
refs: ENT_COMP_CONTENT_RULES.C, ENT_PLAT_DESIGN_TOKENS, POL_VISIBILIDAD, POL_NUEVO_DOC
aplica_a: [SHARED]
...
## Enforcement
- **Detección:** Output para impresión que no cumple specs físicas (dimensiones, bleed, resolución)
- **Acción:** Bloquear envío a producción, listar desvíos
- **Severidad:** HARD — error de impresión es irrecuperable
