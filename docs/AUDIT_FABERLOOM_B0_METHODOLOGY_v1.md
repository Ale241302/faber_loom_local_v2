# AUDIT_FABERLOOM_B0_METHODOLOGY_v1 — Audit Methodology Framework — Service Design + UX Architecture toolkit
id: AUDIT_FABERLOOM_B0_METHODOLOGY_v1
version: 1.0
status: DRAFT
visibility: [INTERNAL]
...
aplica_a: [FaberLoom]
relacionado: AUDIT_FABERLOOM_B1_SERVICE_BLUEPRINT_v1.md
