...
| Semáforo de inventario | Regla | Es cálculo en ENT_OPS_DEMAND_PLANNING, no artefacto |
...
## Enforcement
- **Detección:** Schema ensamblado sin cumplir todos los requires/policies declarados
- **Acción:** Bloquear output, listar campos faltantes
- **Severidad:** HARD — output incompleto no puede publicarse
