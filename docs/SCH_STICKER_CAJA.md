# SCH_STICKER_CAJA — v1.0 ACTIVO (inherits: SCH_STICKER_BASE)
id: SCH_STICKER_CAJA
version: 1.0
status: ACTIVO
...
Layout: continuo frente-lateral-back

requires:
  - SCH_STICKER_BASE (herencia completa)
  - Layout específico: sticker caja
policies:
...
> Candidato: Goliath USA — hereda SCH_STICKER_BASE + layout caja
