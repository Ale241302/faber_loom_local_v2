...
status: VIGENTE
activation_trigger: INMEDIATO — GOL activo en Amazon, claims de PORON ya en listings
visibility: [PUBLIC]
stamp: VIGENTE — Aprobado CEO 2026-03-14
iso: —
origin: Audit externo ChatGPT — Hallazgo 2
extends: ENT_COMP_CONTENT_RULES.A
aplica_a: [MWT]
...
## Enforcement
- **Detección:** Frase prohibida (sección D) detectada en material comercial, UI, listing o comunicación del scanner
- **Acción:** Bloquear publicación, revertir claim, escalar a CEO con frase exacta y alternativa permitida (sección C)
- **Severidad:** HARD — claim médico puede reclasificar producto ante FDA/ANVISA
