...
- POL_CLAIMS_SCANNER.md — gate publicación + artifact spec auditable
...
| Gate publicación | POL_CLAIMS_SCANNER | — |
...
## Datos de viabilidad ISO 9001 (ref: Perplexity Prompt 5 — investigación marzo 2026)

### Cobertura actual KB vs ISO 9001:2015
- KB de 216 archivos cubre ~70% de requisitos documentales
- Quality policy: ✅ | Quality objectives (KPIs): ✅ | Risk register: ✅ | Process control: ✅ | Audit framework: ✅

### Gaps críticos para certificación
1. Registros operacionales reales (KPIs con datos, corrective actions, feedback clientes) — mínimo 3 meses
2. Auditoría interna ejecutada por externo (1 día, $200-$500)
3. Management review con datos reales (1 sesión formal)
4. Criterios evaluación proveedores formalizados
5. Training record / competence log del CEO

### Costos estimados (micro-empresa 1 persona, remoto)
- Primer año: $3,500–$5,000 (escenario medio)
- Años 2-3: $700–$1,800/año (surveillance)
- Ciclo 3 años lean: $5,000–$8,000
- IAF MD5: 1.5 días de auditoría (mínimo absoluto para 1 persona)

### Timeline proyectado
- Si inicia ahora (marzo 2026) → certificado agosto 2026 (20-22 semanas)
- Si inicia junio 2026 → certificado noviembre 2026
- Constraint principal: 3 meses de registros operacionales (no se puede acelerar)

### Certificadoras en Costa Rica
- INTECO: info@inteco.org, +506 2283 4522 (certificación INTE/ISO 9001:2015, reconocida IQNet)
- INTERCERT LATAM: intercertlatam.com/cr
- Pacific Certifications / Factocert: 100% remoto, bajo costo (ideal para ecommerce sin planta física)

### ROI
- Amazon Business permite mostrar ISO 9001 como credencial. Buyers gastaron $400M+ con sellers certificados en 2024.
- Certificarse a 1 persona cuesta ~$4,000. A 10 personas: ~$25,000. Ventaja de timing.
