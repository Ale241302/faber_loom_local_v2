...
id: GUIA_ALE_SPRINT26
version: 1.0
status: DRAFT
visibility: [INTERNAL]
domain: Plataforma (IDX_PLATAFORMA)
stamp: DRAFT v1.0 — 2026-04-08
tipo: Registro especial — instrucciones de ejecución para AG-02 (ref → CLAUDE.md registros especiales)
refs: LOTE_SM_SPRINT26 v2.3
