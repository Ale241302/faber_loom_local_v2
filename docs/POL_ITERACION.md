...
1. Ejecutar checks de taxonomía antes de entregar (refs válidas, policies aplicadas, campos completos, POL_DETERMINISMO, POL_NUNCA_TRADUCIR, POL_ANTI_CONFUSION, POL_DETERMINISMO)
...
## Enforcement
- **Detección:** Output publicado sin pasar por ciclo de iteración completo
- **Acción:** Revertir a DRAFT, requerir iteración
- **Severidad:** SOFT — publicación prematura, no crítica
