...
refs: PLB_AUDIT, ENT_COMP_CONTENT_RULES.C, ENT_PLAT_DESIGN_TOKENS, POL_ANTI_CONFUSION, POL_VISIBILIDAD, POL_PRINT, ENT_MARCA_IDENTIDAD, ENT_COMP_CONTENT_RULES.A
aplica_a: [MWT]
...
- ENT_COMP_CONTENT_RULES.C (paleta completa, tokens semánticos, WCAG ratios verificados, exclusividad color por producto)
...
- ENT_COMP_CONTENT_RULES.A (semáforo GREEN/YELLOW/RED para claims)
