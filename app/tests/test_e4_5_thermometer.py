"""E4-5 — Learning thermometer levels and endpoint."""
...
def test_thermometer_levels(client: TestClient) -> None:
    ...
    assert state["unconsolidated_count"] == 6
